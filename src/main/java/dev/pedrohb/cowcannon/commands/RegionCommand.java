...
import dev.pedrohb.cowcannon.hooks.WorldEditHook;
import dev.pedrohb.cowcannon.models.Region;
import dev.pedrohb.cowcannon.models.Regions;
import dev.pedrohb.cowcannon.models.Tuple;
...
public final class RegionCommand implements CommandExecutor {
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
    ...
    if ("pos1".equals(param)) {
      ...
      sender.sendMessage(
          ChatColor.GOLD + "You are standing in region: " + (standingIn == null ? "none" : standingIn.getName()));
